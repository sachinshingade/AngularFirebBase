...
/* harmony import */ var _shared_services_index__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared/services/index */ "./src/app/shared/services/index.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_14__["environment"].firebaseConfig),
            ...
            providers: [_shared__WEBPACK_IMPORTED_MODULE_9__["AuthGuard"], _shared_services_index__WEBPACK_IMPORTED_MODULE_10__["ApiService"]],
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.deleteStock = function (key) {
        var _this = this;
        if (key === void 0) { key = 'year'; }
        this.stockRef.remove(key).catch(function (error) { return _this.handleError(error); });
    };
...
module.exports = __webpack_require__(/*! /var/www/html/Angular6/YouTube/sbadmin/SB-Admin-BS4-Angular-5/src/main.ts */"./src/main.ts");
